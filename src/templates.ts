...
<head>
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is md.page?","acceptedAnswer":{"@type":"Answer","text":"md.page is a web service that converts Markdown content into clean, hosted HTML pages with shareable URLs. It offers anonymous temporary pages (24-hour expiry, no signup) and permanent pages with custom subdomains for authenticated users."}},{"@type":"Question","name":"Do I need to sign up to use md.page?","acceptedAnswer":{"@type":"Answer","text":"No. You can publish anonymous pages without any signup. Just POST your markdown to the API and get a shareable URL. Pages expire after 24 hours. For permanent pages, sign in with Google."}},{"@type":"Question","name":"How do I use md.page with AI agents?","acceptedAnswer":{"@type":"Answer","text":"md.page integrates with AI agents via MCP server (npx -y mdpage-mcp), Claude Code skill (npx skills add maypaz/md.page), or direct API calls. Any agent that can make HTTP requests can publish markdown as web pages."}},{"@type":"Question","name":"Is md.page free?","acceptedAnswer":{"@type":"Answer","text":"Yes. Both anonymous and authenticated tiers are completely free. Anonymous pages expire after 24 hours. Authenticated users get permanent pages with a personal subdomain."}}]}</script>
